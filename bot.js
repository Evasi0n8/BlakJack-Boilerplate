...
if (message.toLowerCase().indexOf("lol") ) {
        this.sendReply("lol");
        
        }
        
        if (message.toLowerCase().indexOf("battle") ) {
        this.sendReply("You Can challenge me to any tier you want ill wreck you :)");
        
        }

        if (message.toLowerCase().indexOf("op") ) {
        this.sendReply("nah im more op");
        
        }

if (message.toLowerCase().indexOf("where") ) {
        this.sendReply("Look up your ass :)");
        
        }
        
        if (message.toLowerCase().indexOf("bye") ) {
